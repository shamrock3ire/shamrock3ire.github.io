...
Papamamap.prototype.getPopupContent = function(feature)
{
    ...
    if(feature.get('種別') == "認可保育所") {
        ...
        if (feature.get('v_age') !== null) {
            content += feature.get('v_age') + 'に空き有り <a href="http://www.tsukuba-kosodate.jp/?action=common_download_main&upload_id=2694" target="_blank">【詳細】</a>';
　　　　}
        content += '</td>';
        content += '</tr>';
    }
