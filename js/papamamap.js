...
Papamamap.prototype.getPopupContent = function(feature)
{
    ...
    if(feature.get('種別') == "認可外") {
        ...
        if (feature.get('証明') !== null) {
            content += '証明書発行済<a href="http://www.tsukuba-kosodate.jp/nursery/Nursery_school/" target="_blank">(詳細)</a>';
        }
        content += '</td>';
        content += '</tr>';
    }
    if(feature.get('種別') == "認可保育所") {
        ...
        if (feature.get('v_age') !== null) {
            content += feature.get('v_age') + 'に空き有り <a href="http://www.tsukuba-kosodate.jp/index.php?action=journal_view_main_detail&nc_session=gi1u22gm8os0jgjkcqj3ocfcr5&post_id=2107&block_id=261" target="_blank">【詳細】</a>';
　　　　}
        content += '</td>';
        content += '</tr>';
    }
